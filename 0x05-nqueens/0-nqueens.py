#!/usr/bin/python3
"""
This N queens puzzle is the challenge of placing N non-attacking queens on an
...
def printSolution(board):
    """This print the coordinates row and column for the position of
...
def isSafe(board, row, col, n):
    """This is checking if a queen can be placed on board[row][col]
    Arg:
       - board: matrix[n][n], list of list
...
def solveNQUtil(board, col, n):
    """This function to solve the n queen problem using Backtracking
...
if __name__ == "__main__":
    """ This Take the argv from the command line:
